...
const Header = () => {
  ...
  // Assign the correct icon to a capitalized variable
      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 text-gray-800 dark:text-white font-bold text-xl flex items-center gap-2">
