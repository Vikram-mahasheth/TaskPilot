                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                         ...
                         <div className="space-y-3">
                            ...
                            {user.role === 'admin' && <select onChange={(e) => handleFieldChange('assignee', e.target.value)} value={formState.assignee} className="w-full p-2 border rounded-md dark:bg-gray-700"><option value="">Unassigned</option>{users.map(u => <option key={u._id} value={u._id}>{u && u.name ? u.name : "Unknown"}</option>)}</select>}
